...
@APICommand(name = CreateDisasterRecoveryClusterVmCmd.APINAME,
        description = "Create Disaster Recovery Vm",
...
public class CreateDisasterRecoveryClusterVmCmd extends BaseAsyncCreateCmd {
    ...
    public String getEventDescription() {
        return "creating a disaster recovery virtual machine";
    }
    ...
    public void create() throws CloudRuntimeException {
        try {
            ...
            if (result != null) {
                ...
                throw new ServerApiException(ApiErrorCode.INTERNAL_ERROR, "Failed to create disaster recovery vm entity : " + virtualMachineId);
            }
